...
- **CORE-01.T07 #860** — tested head `5c77f629ed65dd080a7c7dc01ac2a35ad27979a3`, CI `35689767082`, merged as `1e4462ea038026696a11fc2689f597e233dc2718`. Rust plus native Ubuntu 24.04/Windows 2025/macOS 15 passed. The named 4096-byte worker I/O budget bounds encoded `Cancel`/`Cancelled`; no parser-fuzz execution or product-latency claim.
- **CORE-01.T07 #861** — tested head `2865249b8a7ea9fbd2caf25cf47ddd67aa2d1192`, CI `35698300201`, merged as `bc8d7d1527c20835bbb0ad732c6453c804d13a26`. Rust and all three native jobs passed. One `poll_control` call now shares the allowance across inbound control and control/progress backlog flushing with control-first ordering; separate send/heartbeat/progress operations, suspend semantics, external-effect reconciliation and independent task acceptance remain outside scope.
- **CORE-01.T08 #862** — tested head `ce8fe1b18b16116ffe223fb565f240ad69c79daa`, CI `35704136833`, merged as `1e566b92afbcdb3ad5e45ae5eaf5b3627ff886be`. Rust and native Ubuntu/Windows/macOS passed. Conformance failures now retain deterministic machine-readable JSON and non-zero exit; existing parser-fuzz campaigns remain bounded smoke evidence rather than exhaustive qualification.
- **CORE-02.T01 #863-#868** — existing-store identity, Linux GNU owner crash-release, migration-shaped process-crash rollback, persisted FK/CHECK/immutable-identity constraints, the bounded storage durability matrix and portable canonical-profile ownership are merged. #864 CI `35720174363` merged as `917b7f4a62eded98f8ef3e4a39bdc1a65e26bec7`; #865 head `e746dece276fc0d4347923b320a63cb51bce224b`, CI `35737639027`, merged as `8a3c004ca217edfc39956408b655060e2ecfa6d0`; #866 head `800e7c76a30cf7b80700e65b7e8c2084c11bb6c3`, CI `35751757023`, merged as `a2ed9ddf28dc541016cbe147b0f75e65e4e8e00e`; #867 head `ba7b981369aa0658d94a46b50303ebb38da6bd9b`, CI `35765210800`, merged as `cdf8cccfabd9f9a36651f398abd8f9014029ec24`; #868 head `5e8e1f84988fad0c6abdfcc40e7298a659dbe57e`, CI `35784773813`, merged as current main `87887c8977cb299a94c677c8c4ec1ca3c6027240`. Each exact-head run passed Rust plus native Ubuntu/Windows/macOS in its recorded scope. #868 post-merge main CI `35790379774` also passed all Rust/native jobs.

The portable owner is a cooperative trusted-owner primitive, not hostile same-user containment. The durability matrix explicitly leaves named filesystems, sudden power loss/VM reset and controller/cache loss unqualified. PR #865 kills a child holding the same transactional mutation shape as production migrations but does not inject termination inside private `apply_migrations_through`. CORE-02.T01 therefore remains partial, and independent whole-task acceptance is still required.
