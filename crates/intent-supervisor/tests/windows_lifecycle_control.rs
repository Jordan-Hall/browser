...
use intent_supervisor::{
    HealthPolicy, LifecycleControl, WindowsBootstrapPacket, WindowsExecutableIdentity,
    WindowsPendingWorker,
};
...
fn windows_lifecycle_control_child() -> TestResult {
    ...
    match control_message {
        LifecycleControl::Cancel { generation, .. } if generation == instance()? => Ok(()),
