...
- [x] Merge bounded Windows CORE-01.T05 follow-through through #882: real child/two-lane authentication, pre/post-auth revocation, shared restart budgeting, bounded stop/terminate observation, executable identity pinning retained through launch, pinned-only public launch/restart entry points, authenticated Cancel-first control, and restart-budget integration across an escalated generation and fresh cooperative restart; keep T05 open/partial because product scheduler orchestration, Cancelled acknowledgement/product semantics, full executable sealing/containment, macOS supervision and independent whole-task acceptance remain.
...
Current implementation and verification status: docs/core-native-progress.md. CORE-01.T01-T04 are accepted; T05 remains partial and T06-T08 remain implemented_pending_acceptance. CORE-01.T05 Windows follow-through #870-#882 is merged with exact-head native CI for bounded real-child launch/authentication, pre/post-auth ownership revocation and fresh-generation recovery, shared restart budgeting, cooperative stop/hard escalation with bounded termination observation, executable identity pinning retained through owned launch, pinned-only public launch/restart entry points, an authenticated platform-neutral Cancel control bridge, and controlled-stop/restart-budget integration. It still does not establish product scheduler orchestration, Cancelled acknowledgement/product semantics, full executable sealing/containment, any macOS supervisor, or independent whole-task acceptance. CORE-01.T07 #860/#861, CORE-01.T08 #862, and CORE-02.T01 #863-#868 are also merged with exact-head native CI in their documented scopes. CORE-02.T01 remains partial for controlled filesystem/power-loss qualification and independent acceptance. No later workstream starts until CORE closes.
