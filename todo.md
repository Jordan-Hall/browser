...
- [x] Merge bounded Windows CORE-01.T05 lifecycle follow-through through #876: real child spawn/two-lane authentication, pre/post-auth revocation with fresh-generation recovery, shared restart budgeting, cooperative stop with hard escalation, and separately bounded terminate-grace completion observation; keep T05 open/partial because production scheduler/Cancel-message integration, a Windows cooperative-signal equivalent, executable sealing/containment, macOS supervision and independent whole-task acceptance remain.
